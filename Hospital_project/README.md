...
### 3. Data Integration
- Combined multiple datasets using SQL joins and Python
...
- Patient admission & readmission analysis  
...
- Pharmacy and financial records  
...
- Chronic patients contribute to higher hospital costs  
- Operational inefficiencies were identified in multiple areas  
...
- Improve real-time monitoring of hospital performance  
